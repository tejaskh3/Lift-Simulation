...
formSubmitButton.addEventListener("click", (e) => {
  ...
  const numberOfFloors =
    document.getElementsByClassName("simulator-input")[0].value;
  const numberOfLifts =
    document.getElementsByClassName("simulator-input")[1].value;
  ...
  if (numberOfFloors <= 0 || numberOfLifts <= 0) {
    alert("Please enter more than or equal to 1 in both lift and floor.");
    return;
  }
